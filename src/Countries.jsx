...
function Country() {
    ...
    let searchCountry = (e) => {
        ...
        flaglist.innerHTML = name.map((flag) => `<div class='countryCard' style=display:flex;flex-Direction:column;justify-Content:center;align-Items:center;padding:10px;margin:10px;border:2px;border-style:solid;border-color:#E1E1E1;border-radius:10px;width:200px;height:200px;>
    ...
    return (
        <>
            ...
            <div id="mainArea" style={{
                ...
                {
                    flags.map((flag) => {
                        return <CountryCard className=".countryCard" key={flag.altSpellings[0]} name={flag.name.common} flagIMG={flag.flags.png} flagAbbr={flag.altSpellings[0]} /> 
                    })
                }
            </div>
        </>
